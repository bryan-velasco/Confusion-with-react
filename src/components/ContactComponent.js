...
class Contact extends Component {
    ...
    handleBlur = (field) => (event) => {
        // 'event' prevents doing repeatedly calls setState inside the input
        this.setState({
            //dot dot dot, means al those
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if(this.state.touched.lastname && lastname.length < 3){
            ...
            errors.lastname = "Last Name Name Should be <= 10 characters";
        }
                        ...
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row className="mt-2">
                                <Col md={{ size: 6, offset: 2 }}>
                                    <FormGroup checked>{/***This is a Checkbox with checked argument****/}
                                        <Label checked>
